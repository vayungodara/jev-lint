...
- Markers (`TODO`, `[?]`, …) and wikilinks inside inline code (single or double backticks) are no longer reported. On the reference vault this removes 3 false positives (1 missing-page, 2 unresolved) from the 16 findings recorded in the README.
